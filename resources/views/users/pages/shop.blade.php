...
<div class="home">
	<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/messi.jpg"></div>
			...
			<div class="col-lg-3">
				...
				<div class="shop_sidebar">
					<div class="sidebar_section">
						<div class="sidebar_title">ໝວດໝູ່ສິນຄ້າ</div>
					...
					<!--Filter Price and Color
						<div class="sidebar_section filter_by_section">
							<div class="sidebar_title">ກັ່ນຕອງ</div>
							<div class="sidebar_subtitle">ລາຄາ</div>
						...
						<div class="sidebar_section">
							<div class="sidebar_subtitle color_subtitle">ສີ</div>
             ...
             -->
					...
					<div class="sidebar_section">
						<div class="sidebar_subtitle brands_subtitle">ຍີ່ຫໍ້</div>
			...
			<div class="col-lg-9">
				...
				<div class="shop_content">
					<div class="shop_bar clearfix">
						<div class="shop_product_count"><span>186</span> ພົບສິນຄ້າ</div>
						<div class="shop_sorting">
							<span>Sort by:</span>
							<ul>
								<li>
									<span class="sorting_text">ນິຍົມ<i class="fas fa-chevron-down"></span></i>
									<ul>
										<li class="shop_sorting_button" data-isotope-option='{ "sortBy": "original-order" }'>ນິຍົມ</li>
										<li class="shop_sorting_button" data-isotope-option='{ "sortBy": "name" }'>ຊື່</li>
										<li class="shop_sorting_button" data-isotope-option='{ "sortBy": "price" }'>ລາຄາ</li>
									</ul>
								</li>
							</ul>
						</div>
		...
		<div class="row">
			<div class="col">
				<div class="viewed_title_container">
					<h3 class="viewed_title">ສິນຄ້າກ່ອນໜ້ານີ້</h3>
