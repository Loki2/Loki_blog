...
<div class="content-wrapper">
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">ຂໍ້ມູນແຂວງ</h3>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip"
                    title="Collapse">
              <i class="fa fa-minus"></i></button>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">ຈັດການຂໍ້ມູນແຂວງ</h3>

              <div class="box-tools">
                  <button class="btn btn-success" data-toggle="modal" data-target="#CatModal">ເພີ່ມແຂວງ</button>
              </div>
            </div>
            <!-- /.box-header -->
            ...
            <!-- Start New Modal here -->
               ...
               <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <h5 class="modal-title" id="CatModalLabel">ສ້າງຂໍ້ມູນແຂວງ</h5>
                     </div>
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group col-md-6">
                        <label for="category">ຊື່ແຂວງ</label>
                        <input type="password" class="form-control" id="category" placeholder="ຊື່ແຂວງ">
                      </div>
